...
public class ${JavaModName}JeiPlugin implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		<#list recipe_types as type>
            registration.addRecipes(${type.getModElement().getRegistryName()?c_upper_case}_JEI_CATEGORY.getRecipeType(), getRecipes(${JavaModName}RecipeTypes.${type.getModElement().getRegistryName()?c_upper_case}_TYPE.get()));
		</#list>
	}

    private static <I extends RecipeInput, R extends Recipe<I>> List<RecipeHolder<R>> getRecipes(RecipeType<R> recipeType) {
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        <#list recipe_types as type>
            registration.addRecipeCatalysts(${type.getModElement().getRegistryName()?c_upper_case}_JEI_CATEGORY.getRecipeType(), ${type.getModElement().getRegistryName()?c_upper_case}_JEI_CATEGORY.getCatalysts());
        </#list>
	}
